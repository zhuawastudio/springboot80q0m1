          ...
          <el-form-item class="input" label="新旧程度" prop="xinjiuchengdu">
              <el-input v-model="ruleForm.xinjiuchengdu" 
                placeholder="新旧程度" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可接受价格" prop="kejieshoujiage">
          <el-input v-model="ruleForm.kejieshoujiage" 
              placeholder="可接受价格" clearable  :readonly="ro.kejieshoujiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可接受价格" prop="kejieshoujiage">
              <el-input v-model="ruleForm.kejieshoujiage" 
                placeholder="可接受价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="品牌" prop="pinpai">
              <el-input v-model="ruleForm.pinpai" 
                placeholder="品牌" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="商品描述" prop="shangpinmiaoshu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinmiaoshu" label="商品描述" prop="shangpinmiaoshu">
                    <span>{{ruleForm.shangpinmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinjiuchengdu = true;
            continue;
	            	            ...
	            	            if(o=='kejieshoujiage'){
            this.ruleForm.kejieshoujiage = obj[o];
	    this.ro.kejieshoujiage = true;
            continue;
          }
	            	            if(o=='yonghuming'){
